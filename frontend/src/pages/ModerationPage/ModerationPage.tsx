...
// TanStack Table imports (убрали getPaginationRowModel)
import {
    ColumnDef,
    getCoreRowModel,
    getFilteredRowModel,
...
import AlbumModalModeration from '../../components/AlbumModalModeration/AlbumModalModeration';
...
const ModerationPage: React.FC<ModerationPageProps> = ({ onModerateAlbum }) => {
    ...
    // 5. Инициализация таблицы (без пагинации)
    const table = useReactTable({
        ...
        // pagination убран — показываем всё сразу
    });
    ...
    return (
        <div className="moderation-page-container">
            ...
            <div className="moderation-content">
                ...
                {/* Сетка карточек — скроллится как раньше */}
